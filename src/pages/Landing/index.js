	...
	return (
		<div className="flex flex-col justify-center items-center gap-5">
			<div className="text-4xl font-bold text-center">
				Organize your <span className="block">work and life,</span> finally.
			</div>
			<div className="text-center text-xl">
				Become focused, organized,
				<span className="block">and calm with Todoist.</span>
				<span className="block">The world&apos;s #1 task manager</span>
				<span className="block">and to-do list app.</span>
			</div>
